...
if [ ! -f $db_path ]; then
	...
	echo "CREATE TABLE users (id INTEGER PRIMARY KEY AUTOINCREMENT, email TEXT NOT NULL UNIQUE, password TEXT NOT NULL, extra TEXT, privileges TEXT NOT NULL DEFAULT '');" | sqlite3 $db_path;
